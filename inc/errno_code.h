...
/*                                             +#+    +#+   +#+     +#+       */
/*   Created: 2023/11/18 03:17:55 by amahla  #+#      #+#  #+#     #+#        */
/*   Updated: 2023/11/18 03:24:32 by amahla ###       ########     ########   */
/*                                                                            */
/* ************************************************************************** */


#ifndef __ERRNO_CODE_H__
# define __ERRNO_CODE_H__
...
# define ERRNO_CODE { \
	...
	[513] = { "ERESTARTNOINTR", "To be restarted if SA_RESTART is set" }, \
	...
	[521] = { "EBADHANDLE", "Parameter not supported" }, \
	[522] = { "ENOTSYNC", "" }, \
	[523] = { "EBADCOOKIE", "" }, \
	[524] = { "ENOTSUPP", "" }, \
	[525] = { "ETOOSMALL", "" }, \
